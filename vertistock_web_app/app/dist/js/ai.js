...
document.addEventListener("DOMContentLoaded", function () {
  ...
  var submitBtn = document.querySelector('#send-message');
  var responseArea = document.querySelector('#responseArea');
  var aiToggle = document.querySelector('#ai-toggle');
  ...
  var DEEPSEEK_API_KEY = 'sk-46fd6d8c2e694aaeb5958d89fd6e0792';
  ...
  function _processQuery() {
    _processQuery = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee2() {
      var question, data;
      return _regeneratorRuntime().wrap(function _callee2$(_context2) {
        while (1) switch (_context2.prev = _context2.next) {
          ...
          case 3:
            ...
            _context2.next = 8;
            return handleWarehouseQuery(question);
          case 8:
            data = _context2.sent;
  ...
  function handleWarehouseQuery(_x) {
    return _handleWarehouseQuery.apply(this, arguments);
  }
  function _handleWarehouseQuery() {
    _handleWarehouseQuery = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee3(userMsg) {
      var systemPrompt, payload, response;
      return _regeneratorRuntime().wrap(function _callee3$(_context3) {
        while (1) switch (_context3.prev = _context3.next) {
          case 0:
            systemPrompt = "Sei un esperto AI specializzato in magazzini automatici.\nFornisci risposte tecniche su:\n- Sistemi AS/RS\n- Ottimizzazione layout\n- Tecnologie RFID/IoT\n- Standard di sicurezza ANSI/RIA R15.08\n- Software WMS avanzati\n\nRifiuta gentilmente richieste non pertinenti.";
            payload = {
              model: "deepseek-chat",
              messages: [{
                role: "system",
          ...
          case 4:
            ...
            throw new Error("Errore API: ".concat(response.status));
          case 7:
  ...
  function displayResponse(data) {
    ...
    var sanitizedContent = content.replace(/</g, '&lt;').replace(/>/g, '&gt;');
    responseArea.innerHTML = "\n    <div class=\"response-card\">\n      ".concat(sanitizedContent.replace(/\n/g, '<br>'), "\n    </div>\n  ");
  }
  function displayError(error) {
    console.error('Errore:', error);
    responseArea.innerHTML = "\n    <div class=\"response-card\" style=\"color: #dc3545\">\n      Errore: ".concat(error.message || 'Richiesta fallita', "\n    </div>\n  ");
  }
});
/******/ })()
;